...
namespace Glsl
{
    ...
    /// instances. Each BodyColor channel remains unchanged inside
    /// the integer interval [0, 255].
    /// \code
    /// sf::Glsl::Ivec4 zeroVector;
    /// sf::Glsl::Ivec4 vector(1, 2, 3, 4);
    /// sf::Glsl::Ivec4 BodyColor = sf::Color::Cyan;
    /// \endcode
    ////////////////////////////////////////////////////////////
